...
public class SwipeAnimationButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.SwipeAnimationButton1);

        defaultBackground = ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton1_defaultBackground1, R.drawable.shape_button_neutral));
        defaultDrawable = ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton1_defaultDrawable1, R.drawable.heart));
        ...
        mBackground.setBackground(ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton1_background1, R.drawable.shape_rounded)));
        ...
        rightSwipeDrawable = ContextCompat.getDrawable(getContext(), ta.getInteger(R.styleable.SwipeAnimationButton1_rightSwipeDrawable1, R.drawable.cat));
        rightSwipeBackground = ContextCompat.getDrawable(context, ta.getInteger(R.styleable.SwipeAnimationButton1_defaultBackground1, R.drawable.shape_button));
        leftSwipeDrawable = ContextCompat.getDrawable(getContext(), ta.getInteger(R.styleable.SwipeAnimationButton1_leftSwipeDrawable1, R.drawable.dog));
        leftSwipeBackground = ContextCompat.getDrawable(getContext(), ta.getInteger(R.styleable.SwipeAnimationButton1_leftSwipeBackground1, R.drawable.gradient_radius_grey));

        mDuration = ta.getInteger(R.styleable.SwipeAnimationButton1_duration1, 200);
        slidingButton.setImageDrawable(defaultDrawable);
        slidingButton.setPadding(44, 40, 44, 40);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        if (active) {
                            ...
                            System.out.println("x"+slidingButton.getX() + " slidingButton.getWidth()="+slidingButton.getWidth()+" widx75="+getWidth() * 0.5);
